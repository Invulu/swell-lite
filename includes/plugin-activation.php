 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Swell Lite
...
add_action( 'tgmpa_register', 'swell_lite_register_required_plugins' );
...
function swell_lite_register_required_plugins() {
	 ...
	 */
	$config = array(
		'id'           => 'swell-lite',                 // Unique ID for hashing notices for multiple instances of TGMPA.
