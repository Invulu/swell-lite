					...
					<div class="page-holder shadow radius-full">
						...
						<div class="article clearfix">
							...
							<div class="archive-column">
								<h6><?php esc_html_e("By Page:", 'swelllite'); ?></h6>
								<ul><?php wp_list_pages('title_li='); ?></ul>
							</div>
							
							<div class="archive-column">
								<h6><?php esc_html_e("By Post:", 'swelllite'); ?></h6>
								<ul><?php wp_get_archives('type=postbypost&limit=100'); ?></ul>
							</div>
							
							<div class="archive-column last">
								<h6><?php esc_html_e("By Month:", 'swelllite'); ?></h6>
								<ul><?php wp_get_archives('type=monthly'); ?></ul>
								<br />
								<h6><?php esc_html_e("By Category:", 'swelllite'); ?></h6>
