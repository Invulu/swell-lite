<?php if ( get_theme_mod( ''swell-lite'_logo', get_template_directory_uri() . '/images/logo.png' ) ) { ?>
	...
	<h1 id="logo" class="vertical-center <?php if (get_theme_mod('title_align', 'center') == 'center') { ?>text-center<?php } if (get_theme_mod('title_align') == 'right') { ?>text-right<?php } ?>">
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
			<img src="<?php echo esc_url( get_theme_mod( ''swell-lite'_logo', get_template_directory_uri() . '/images/logo.png' ) ); ?>" alt="" />
