...
<div <?php post_class('archive-holder shadow radius-full'); ?> id="post-<?php the_ID(); ?>">
	...
	<?php if ( has_post_thumbnail() ) { ?>
		<a class="feature-img radius-top" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php echo esc_attr( sprintf( esc_html__( 'Permalink to %s', 'swelllite' ), the_title_attribute( 'echo=0' ) ) ); ?>"><?php the_post_thumbnail( 'swell-featured-large' ); ?></a>
	<?php } ?>
	...
	<div class="article">
		...
		<?php $tag_list = get_the_tag_list( esc_html__( ", ", 'swelllite' ) ); if ( ! empty( $tag_list ) || has_category() ) { ?>
		
			<!-- BEGIN .post-meta -->
			<div class="post-meta radius-full">
			
				<p><i class="fa fa-bars"></i> <?php esc_html_e("Category:", 'swelllite'); ?> <?php the_category(', '); ?>   <?php if ( ! empty( $tag_list ) ) { ?><i class="fa fa-tags"></i> <?php esc_html_e("Tags:", 'swelllite'); ?> <?php the_tags(''); ?><?php } ?></p>
...
<p><?php esc_html_e("Sorry, no posts matched your criteria.", 'swelllite'); ?></p>
